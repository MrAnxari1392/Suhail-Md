...
global.gurl  =process.env.GURL  || "https://chat.whatsapp.com/GeFfbydo1Yn6vmeBLJgc7P";
global.website=process.env.GURL || "https://chat.whatsapp.com/JbuprEsO0r2Ilm4LIjfyE4" ; 
...
global.caption = process.env.CAPTION || global.caption || "☠︎~• ┼།🕊️꯭꯭⃝‌ٖ 𝞛𝞘𝙎𝙎 𝞛𝞓𝙇𝞘𝞖𝞓" 
...
global.userImages= process.env.USER_IMAGES || "https://telegra.ph/file/6ebb78013510ac5b4630c.jpg" // "text" // set Image/video urls here
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "☠︎~• ┼།🕊️꯭꯭⃝‌ٖ 𝞛𝞘𝙎𝙎 𝞛𝞓𝙇𝞘𝞖𝞓",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "☠︎~• ┼།🕊️꯭꯭⃝‌ٖ 𝞛𝞘𝙎𝙎 𝞛𝞓𝙇𝞘𝞖𝞓",
  ownername:process.env.OWNER_NAME|| "☠︎~• ┼།🕊️꯭꯭⃝‌ٖ 𝞛𝞘𝙎𝙎 𝞛𝞓𝙇𝞘𝞖𝞓",
